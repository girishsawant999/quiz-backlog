...
const userSchema = new mongoose.Schema({
  ...
  mobile: { type: String, unique: true, required: [true, 'Mobile number is required'] },
  ...
  role: { type: String, enum: [userRoles.ADMIN, userRoles.APPROVER, userRoles.OPERATOR], default: userRoles.OPERATOR },
